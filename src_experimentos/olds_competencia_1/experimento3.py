#experimento1.py
# EXPERIMENTO 3 : dropeo mcuenta saldo
import numpy as np
import pandas as pd
...
from src.feature_engineering import feature_engineering_lag,feature_engineering_delta,feature_engineering_max_min,feature_engineering_ratio,feature_engineering_linreg,feature_engineering_normalizacion,feature_engineering_drop_cols,feature_engineering_max_min_2
...
def lanzar_experimento_3(fecha:str ,semillas:list[int],proceso_ppal:str ="experimento"): #semillas, si queremos hacer una prediccion final, poner solo una semilla en una lista
    n_semillas = len(semillas)
    name=f"{fecha}_EXPERIMENTO_3"
    logger.info(f"Comienzo del experimento 3 : {name} con {n_semillas} semillas")
...
#############################################################################-----  DESCOMENTAR  ------############################################
    ...
    df=feature_engineering_max_min_2(df,cols_lag_delta_max_min_regl)
